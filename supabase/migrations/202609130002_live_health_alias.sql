-- Workflow-backed Watches use live; legacy Watches use watching. Both require fresh stream evidence.
...
as $$
  select jsonb_build_object(
    ...
    'status', case when w.status in ('watching','live') and not exists (
